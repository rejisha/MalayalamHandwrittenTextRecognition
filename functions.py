...
def process_images(raw_folder, clean_folder, folder_list):
    ...
    for folder in folder_list:
        print(folder)
        # output_folder_path = os.path.join(raw_folder, folder, 'output')
        # print(output_folder_path)
        # if not os.path.exists(output_folder_path):
        #     os.makedirs(output_folder_path)  # Create the outpu
        imglist = process_folder(os.path.join(raw_folder, folder))
